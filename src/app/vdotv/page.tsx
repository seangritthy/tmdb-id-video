...
export default function VDOtvPage() {
  ...
  useEffect(() => {
    ...
    if (isM3U8) {
      ...
      import("hls.js").then(({ default: Hls }) => {
        ...
        if (Hls.isSupported()) {
          ...
          hls.on(Hls.Events.MANIFEST_PARSED, () => {
            video.play().catch((err: any) => console.log("Auto-play blocked:", err));
          });
          ...
          video.src = targetUrl;
          video.play().catch((err: any) => console.log("Native HLS Auto-play blocked:", err));
          setIsHlsSupported(true);
        } else {
      ...
      video.play().catch((err: any) => console.log("Direct source Auto-play blocked:", err));
      setIsHlsSupported(true);
    }
