...
export const siteConfig: SiteConfigType = {
  name: "vdomov",
  description: "Your universe of free movies and TV shows — stream anything, anytime.",
  favicon: "/favicon.ico",
  navItems: [
    {
      label: "Home",
    ...
    },
    {
      label: "VDOtv",
      href: "/vdotv",
      icon: <BiTv className="size-full" />,
      activeIcon: <BiSolidTv className="size-full" />,
    },
    {
      label: "Khmer",
      href: "/khmer",
  ...
  socials: {
    github: "https://github.com/wisnuwirayuda15/vdomov",
  },
};
