      ...
      <div className="md:grid md:grid-cols-[auto_1fr] md:gap-6">
        ...
        <div className="flex flex-col gap-8">
          <div id="title" className="flex flex-col gap-1 md:gap-2">
            ...
            <div className="md:text-md flex flex-wrap gap-1 text-xs md:gap-2">
              <div className="flex items-center gap-1">
                <Season />
                <span>
                  {tv.number_of_seasons} {dictionary.season}{tv.number_of_seasons > 1 ? "s" : ""}
                </span>
              </div>
              <p>&#8226;</p>
              <div className="flex items-center gap-1">
                <List />
                <span>
                  {tv.number_of_episodes} {dictionary.episode}{tv.number_of_episodes > 1 ? "s" : ""}
                </span>
              </div>
              <p>&#8226;</p>
              <div className="flex items-center gap-1">
          ...
          <div id="story" className="flex flex-col gap-2">
            <SectionTitle color="warning">{dictionary.storyLine}</SectionTitle>
